...
@property (nonatomic, strong) YWMediaGesturesView  *gesturesView;
...
#pragma mark-- YWMediaGesturesViewdelegate 代理
// 移动
...
- (void)creatSubviews {
    ...
    self.closeBtn = ({
        ...
        [closeBtn setImage:[UIImage imageNamed:@"icon_back"] forState:UIControlStateNormal];
    ...
    self.fullScreenBtn = ({
        ...
        [btn setImage:[UIImage imageNamed:@"icon_full_no"] forState:UIControlStateSelected];
    ...
    self.gesturesView = ({
        YWMediaGesturesView *view =[YWMediaGesturesView new];
        view.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0];
        view;
    });
    self.gesturesView.delegate = (id)self;
...
- (void)layoutSubviews {
    ...
    self.titleLabel.frame = CGRectMake(_closeBtn.right, topMaigin, ttW, LABEL_H);
